...
const SELFRIDGES_LISTINGS: Record<string, string[]> = {
  Makeup: [
    ...
    "beauty/makeup/face/bronzer-highlighter",
    "beauty/makeup/face/bronzer",
    "beauty/makeup/face/highlighter",
    "beauty/makeup/face/setting-powders",
    ...
    "beauty/makeup/eyes/eye-shadow-palettes",
    "beauty/makeup/eyebrows",
    "beauty/makeup/lips",
    "beauty/makeup/lips/lipstick",
    "beauty/makeup/lips/lip-gloss",
    "beauty/makeup/lips/lip-liner",
    "beauty/makeup/lips/lip-care",
    "beauty/makeup/nails",
    "beauty/bestseller",
    "beauty/new-in",
    "beauty/new-in/new-in-makeup",
    "beauty/new-in/new-in-skincare",
    "beauty/new-in/new-in-fragrance"
  ],
  Skincare: [
    "beauty/skincare",
    ...
    "beauty/skincare/skincare-sets",
    "beauty/skincare/mens-skincare",
    "beauty/skincare/lip-care",
    "beauty/skincare/neck-bust",
    "beauty/skincare/vitamins-supplements",
    "beauty/korean-beauty-skincare",
    "beauty/suncare-tanning/suncare",
    "beauty/bodycare",
    "beauty/bodycare/body-lotion-cream",
    "beauty/bodycare/body-scrub-exfoliator",
    "beauty/bodycare/bath-shower",
    "beauty/bodycare/hand-care",
    "beauty/wellness"
  ],
  Haircare: [
    "beauty/haircare",
    ...
    "beauty/haircare/scalp-care",
    "beauty/haircare/hair-sets",
    // Brand-scoped haircare grids (brand page slug returns 0; category path works)
    "kerastase/beauty/haircare",
    "olaplex/beauty/haircare",
    "moroccanoil/beauty/haircare",
    "ouai/beauty/haircare",
    "k18/beauty/haircare",
    "color-wow/beauty/haircare",
    "christophe-robin/beauty/haircare",
    "bumble-and-bumble/beauty/haircare",
    "philip-kingsley/beauty/haircare",
    "gisou/beauty/haircare",
    "davines/beauty/haircare",
    "amika/beauty/haircare",
    "shu-uemura/beauty/haircare",
    "ghd/beauty/haircare"
  ],
  "Beauty tools": [
  ...
  Fragrance: [
    ...
    // Brand-scoped fragrance grids — brand page slugs return 0 for fragrance houses;
    // the brand-scoped category path exposes the full product grid in __NEXT_DATA__.
    ...
    "jo-malone-london/beauty/fragrance",
    "diptyque/beauty/fragrance",
    "maison-margiela/beauty/fragrance",
    "creed/beauty/fragrance",
    "guerlain/beauty/fragrance",
    "acqua-di-parma/beauty/fragrance",
    "penhaligons/beauty/fragrance",
    "carolina-herrera/beauty/fragrance",
    "narciso-rodriguez/beauty/fragrance",
    "le-labo/beauty/fragrance",
    "frederic-malle/beauty/fragrance",
    "parfums-de-marly/beauty/fragrance",
    "amouage/beauty/fragrance",
    "serge-lutens/beauty/fragrance",
    "viktor-and-rolf/beauty/fragrance",
    "maison-francis-kurkdjian/beauty/fragrance",
    "tom-ford/beauty/fragrance",
    "yves-saint-laurent/beauty/fragrance",
    "lancome/beauty/fragrance",
    "givenchy/beauty/fragrance",
    "valentino/beauty/fragrance",
    "burberry/beauty/fragrance",
    "marc-jacobs/beauty/fragrance",
    "versace/beauty/fragrance",
    "dolce-gabbana/beauty/fragrance",
    "hugo-boss/beauty/fragrance",
    "davidoff/beauty/fragrance",
    "calvin-klein/beauty/fragrance",
    "armani/beauty/fragrance"
  ]
};
...
// Benefit Cosmetics — brand slug 404s on Selfridges, so we paginate two search
// terms that reliably surface Benefit-branded products. "benefit cosmetics" pages
// 1–8 gives up to 480 candidates; "benefit" alone adds any products where the
// brand is listed without the "Cosmetics" suffix. Brand filter keeps only rows
// whose extracted brand name contains "benefit".
export const SELFRIDGES_BENEFIT_URLS: string[] = [
  ...
  "https://www.selfridges.com/GB/en/cat/?pge=4&ppp=60&sort=relevance&term=benefit+cosmetics",
  "https://www.selfridges.com/GB/en/cat/?pge=5&ppp=60&sort=relevance&term=benefit+cosmetics",
  "https://www.selfridges.com/GB/en/cat/?pge=6&ppp=60&sort=relevance&term=benefit+cosmetics",
  "https://www.selfridges.com/GB/en/cat/?pge=7&ppp=60&sort=relevance&term=benefit+cosmetics",
  "https://www.selfridges.com/GB/en/cat/?pge=8&ppp=60&sort=relevance&term=benefit+cosmetics",
  // "benefit" alone catches products whose brand name is just "Benefit" not "Benefit Cosmetics"
  "https://www.selfridges.com/GB/en/cat/?pge=1&ppp=60&sort=relevance&term=benefit",
  "https://www.selfridges.com/GB/en/cat/?pge=2&ppp=60&sort=relevance&term=benefit",
];
...
export const SELFRIDGES_BRAND_SLUGS: string[] = [
  // Makeup — prestige (brand page at /GB/en/cat/<slug>/ exposes __NEXT_DATA__ products)
  "huda-beauty",
  "charlotte-tilbury",
  "fenty-beauty",
  "nars",
  ...
  "kate-somerville",
  "goop-beauty",
  // Haircare — brand pages that expose __NEXT_DATA__ products
  "olaplex",
  // Fragrance — generic brand pages rarely expose product grids;
  // fragrance houses are covered via brand-scoped /beauty/fragrance/ listing pages above.
  "byredo",
  // Beauty tools
  "foreo",
  "nuface",
