...
const PROMOS: Record<string, Promo> = {
  ...
  "8bd9871e-a3bf-405e-b168-704ffd197698": { compareAtUsd: 50, label: "Any 4 for this price" }, // gisou-lip-oil-raspberry-swirl
  "4e3afa47-bd5f-40eb-9ee1-e2844241d337": { compareAtUsd: 50, label: "Any 4 for this price" }, // gisou-lip-oil-bee-llini-peach
  "6bfe5abb-43d7-4693-bfe7-3c8ff692b741": { compareAtUsd: 50, label: "Any 4 for this price" }, // gisou-lip-oil-glazed-plum
  "77d5e642-ca1a-48ab-ada4-f00d73af58fe": { compareAtUsd: 60, label: "Any 4 for this price" }, // gisou-hair-perfume-wildflower-honey
  "a08f1d2e-95e9-43fa-ae8c-d6ae0051e6e4": { compareAtUsd: 60, label: "Any 4 for this price" }, // gisou-hair-perfume-wild-rose
  "dce6744e-53f8-4baa-98bf-275f2d623b36": { compareAtUsd: 60, label: "Any 4 for this price" }, // gisou-hair-perfume-lavender-berry
