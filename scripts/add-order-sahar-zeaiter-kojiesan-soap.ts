/**
 * New order for Sahar Zeaiter: 1x Kojie San HydroMoist Skin Lightening &
 * Brightening Soap 135g (the product just added, $7). Payment: cod,
 * confirmed — per standing instruction ([[lara_order_entry_defaults]]).
 *
 * Run:  npx ts-node scripts/add-order-sahar-zeaiter-kojiesan-soap.ts
 */
...
const PRODUCT_ID = "28ecf896-9dcc-4f04-baf0-2e7325b70de5"; // Kojie San HydroMoist Soap 135g

const CUSTOMER = {
  full_name: "Sahar Zeaiter",
  phone: "03015050",
  address: "Beirut, Bir Hassan, mafra2 ba3ed gallery daher, tene bineye shmel tima 41, first floor"
};
