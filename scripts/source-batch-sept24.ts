/**
 * Source 3 items just bought, matched to their single unsourced awaiting
 * order line each (same pattern as mark-sourced-batch-*.ts precedents).
 *
 *   SBB-974645  Batoul Dbouk   Makeup By Mario Soft Pop Blush Stick    $31
 *   SBB-335181  Lea Sbeity     Phlur Vanilla Skin mist 90ml            $21
 *   SBB-361403  Reem Al Maaz   Huda Easy Bake Mini Loose Powder
 *                              Cherry Blossom (the correct size,
 *                              after the earlier wrong-size revert)     $21
 *
 * cost_gbp = cost_usd / 1.3, as in the other mark-sourced scripts.
 *
 * Run:  npx ts-node scripts/source-batch-sept24.ts
 */
...
const LINES: Array<{ order: string; productName: string; costUsd: number }> = [
  { order: "SBB-974645", productName: "Soft Pop Blush Stick", costUsd: 31 },
  { order: "SBB-335181", productName: "Vanilla Skin hair and body fragrance mist 90ml", costUsd: 21 },
  { order: "SBB-361403", productName: "Easy Bake Mini Loose Powder 6g — Shade: CHERRY BLOSSOM", costUsd: 21 }
];
