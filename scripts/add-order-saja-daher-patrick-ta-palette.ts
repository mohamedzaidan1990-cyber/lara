/**
 * Order for customer Saja Daher: Patrick Ta Major Dimension Dream Date
 * Essential Artistry Edit Eyeshadow Palette ($62). Payment: cod, confirmed
 * — per standing instruction ([[lara_order_entry_defaults]]).
 *
 * Run:  npx ts-node scripts/add-order-saja-daher-patrick-ta-palette.ts
 */
...
const PRODUCT_ID = "1d575529-9a0e-45f9-a646-bf1e4e891990";

const CUSTOMER = {
  full_name: "Saja Daher",
  phone: "81755018",
  address: "Airport Road, Gallery Daher"
};
...
async function main(): Promise<void> {
  ...
  console.log(`OK  ${order.order_number} — ${CUSTOMER.full_name} — $${priceUsd} — cod / confirmed`);
}
