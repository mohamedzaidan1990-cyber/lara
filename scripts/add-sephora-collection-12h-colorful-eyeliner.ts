/**
 * One-off add: Sephora Collection "12H Colorful Waterproof Retractable
 * Eyeliner" — shade 01 Matte Black (deep black). Retractable pencil with
 * ultra-precise tip, smudger tip and built-in sharpener. Matches the
 * customer's screenshot.
 * Price $28 flat per explicit user instruction (real retail is ~$24).
 * Image is the official Sephora PDP packshot (SKU s2932689), downloaded to
 * /public.
 *
 * Run:  npx ts-node scripts/add-sephora-collection-12h-colorful-eyeliner.ts
 */
