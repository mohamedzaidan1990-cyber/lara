/**
 * One-off manual order (Instagram) for customer Mona Alkazwini.
 *  - 1x NARS Talc-Free Powder Blush — Dolce Vita 888 @ $60
 *    (catalogue product d4d0d8c5-a8b1-4c74-b0a4-13108fdcc086)
 *  - Payment: COD, order confirmed (payment_confirmed = true, status
 *    payment_confirmed) — matches every existing COD order.
 *
 * Run:  npx ts-node scripts/add-order-mona-alkazwini-nars-blush.ts
 */
...
const PRODUCT_ID = "d4d0d8c5-a8b1-4c74-b0a4-13108fdcc086";
